...
<div style='width:200px'>
    Type : <input type='text'  v-model='value' v-on:click="searchName()" v-on:focus="showAuto()">
    <ul class="autocomplete-results" id='autoType'>
      <li class="autocomplete-result" v-bind:key='suggest.id' v-for='suggest in auto' v-on:click="autoName(suggest)">
            {{suggest}}
      </li>
    </ul>
</div>
